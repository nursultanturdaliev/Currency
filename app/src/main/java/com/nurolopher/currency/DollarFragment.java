...
public class DollarFragment extends ListFragment {
   ...
   /* private String mParam1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CurrencyAdapter currencyAdapter = new CurrencyAdapter(getActivity(), R.layout.currency_list_item, DollarContent.ITEMS);
        setListAdapter(currencyAdapter);
/*
        setListAdapter(new ArrayAdapter<DollarContent.DummyItem>(getActivity(),
                android.R.layout.simple_list_item_1, android.R.id.text1, DollarContent.ITEMS));
*/
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (null != mListener) {
            ...
            mListener.onFragmentInteraction(DollarContent.ITEMS.get(position).title);
        }
    }
